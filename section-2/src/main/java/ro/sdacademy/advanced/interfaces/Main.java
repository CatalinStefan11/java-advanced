...
public class Main {
    public static void main(String[] args) {
        ...
        Create a few sample classes that implement your Saveable interface (use the idea of a game,
        with Player and Monsters, but you can also create any type of classes that you want).
